...
# ================= CẤU HÌNH HỆ THỐNG =================
EMAIL_FROM = "ltbinh802@gmail.com"
APP_PASSWORD = "sstu amup qedt rhwj" # Mã 16 ký tự của Google
GMAIL_TO = [
...
TU_KHOA_BO_QUA = ["iphone", "galaxy", "xiaomi", "oppo", "vivo", "huawei", "android",
                  "ipad", "redmi", "realme", "mi-", "sm-",
                  "watch", "band", "garmin", "fitbit", "amazfit", "huami"]
# =====================================================
...
def send_email(mac_la, ten_thiet_bi, thong_tin_log):
    ...
    msg['From'] =  f"RPA Wi-Fi Visitor Scanner <{EMAIL_FROM}>"
